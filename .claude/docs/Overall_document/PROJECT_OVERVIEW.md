> **STALE SNAPSHOT（2026-09-12）**: 2026-06-07 時点の Web 版スナップショット。ジャンル・成長の 3 本柱・施設は 2026-09-12 の V4.0（`game_design_master.md`）で置き換わった。現状は `vision/concept-v3.md` と `.claude/MEMORY.md` を見る。
