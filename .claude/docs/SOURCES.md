...
| カード（剣士 80 種） | `.claude/docs/card_document/swordsman_cards_v4.md` | cards | v4.3（間合い N、#160） | battle, design |
| 敵の数値とロースター | `.claude/docs/enemy_document/enemy_roster_v4.md` | cards | v4.3（間合い N、#160） | battle, design |
