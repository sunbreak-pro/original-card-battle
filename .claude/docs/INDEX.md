...
- `battle_document/battle_ui_ux_v2.md` - **戦闘 UI / UX の正本（2026-09-13、core v4.1 対応）**: 情報設計の全面改訂（属性 5 の枠色 / 特性の合図 / 状態チップ / スタンス枠 / 2 体戦 / 精鋭の予兆 2 段 / 連戦の進捗）、L1 v2 と対案 2 つ、ドラッグ主操作（受け皿 = 単体の相手、投げ上げ線 = 全体と自分向き。投入帯は廃止）、演出の文法（系統 8 × 段 4 × 固有の飾り）、Unity 写像 v2 とアセット一覧。モックアップは `docs/mockups/2026-09-13-battle-uiux-v4-mockup.html`、判断材料は `docs/reports/2026-09-13-battle-uiux-v4-80.html`
