...
| 画像生成（ローカル）   | 条件が来たら測る（2026-09-16 決定 → §9 #23）。月 $30 に届くか、参照画像で同じ顔を保てないときに、8 GB で SDXL 系の速度と VRAM を測る                                                         | ComfyUI（GPL-3.0）+ Animagine XL 4.0（改変なしの RAIL++-M、商用可）                                                                                             | torch と CUDA 12.8 以降のビルドの導入から要る                                                                                                                                                                                                                                                                                                                                                                                              | 可                   |
