...
- Phase 1 計画: `.claude/feature_plans/pixijs_phase1_foundation.md`
- Phase 2 計画: `.claude/feature_plans/pixijs_phase2_battle_effects.md`
- Phase 3 計画: `.claude/feature_plans/pixijs_phase3_asset_pipeline.md`
