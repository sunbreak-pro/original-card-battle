...
// ============================================================================
// SUMMONER CLASS-SPECIFIC EQUIPMENT
// ============================================================================

export const SUMMONER_EQUIPMENT: Record<string, EnhancedEquipmentData> = {
  // --- Head Equipment (3) ---
  sm_helm_01: {
    id: "sm_helm_01",
    typeId: "sm_helm_01",
    name: "Summoner's Hat",
    description: "召喚士の帽子。召喚獣数で被ダメージ軽減。",
    itemType: "equipment",
    type: "helmet",
    equipmentSlot: "helmet",
    durability: 90,
    ...
    skills: [{
      ...
      name: "Summon Guard",
      nameJa: "召喚の守護",
      description: "Reduce damage based on summon count",
      descriptionJa: "召喚獣1体につき被ダメージ-10%。召喚獣3体で被ダメージ-30%",
      effect: { type: "damageReduction", value: 10, condition: "hasSummon" },
      unlockLevel: 0,
    }],
  },
  sm_helm_02: {
    id: "sm_helm_02",
    typeId: "sm_helm_02",
    name: "High Summoner's Hat",
    description: "上級召喚士の帽子。召喚コスト軽減。",
    itemType: "equipment",
    type: "helmet",
    equipmentSlot: "helmet",
    durability: 160,
    ...
    classRestriction: "summoner",
    skills: [{
      id: "summon_acceleration",
      name: "Summon Acceleration",
      nameJa: "召喚加速",
      description: "Reduce summon costs",
      descriptionJa: "召喚カードのコスト-1。維持コスト-1(全召喚獣)",
      effect: { type: "classAbilityBonus", value: 1, classAbilityTarget: "summon" },
      unlockLevel: 0,
    }],
  },
  sm_helm_03: {
    id: "sm_helm_03",
    typeId: "sm_helm_03",
    name: "Summon God's Crown",
    description: "召喚神の冠。維持コスト無料、4体召喚可能。",
    itemType: "equipment",
    type: "helmet",
    equipmentSlot: "helmet",
    durability: 280,
    ...
    skills: [
      {
        ...
        nameJa: "召喚爆発",
        description: "Massive summon boost and death damage",
        descriptionJa: "召喚獣3体時、全召喚獣の能力+80%。召喚獣死亡時、周囲に大ダメージ(死亡召喚獣HP×3)",
        effect: { type: "bonusPerSummon", value: 80 },
        unlockLevel: 0,
      },
      {
        id: "summon_maintain",
        name: "Summon Maintain",
        nameJa: "召喚維持",
        description: "Free maintenance and extra summon slot",
        descriptionJa: "維持コスト0(全召喚獣)。召喚上限+1(最大4体)",
        effect: { type: "classAbilityBonus", value: 1, classAbilityTarget: "summon" },
        unlockLevel: 3,
      },
    ],
  ...
  sm_body_01: {
    ...
    skills: [{
      ...
      name: "Summon Armor",
      nameJa: "召喚の鎧",
      description: "AP boost and damage absorption from summons",
      descriptionJa: "召喚獣1体につきAP+30。召喚獣がダメージ肩代わり+10%",
      effect: { type: "bonusPerSummon", value: 30 },
      unlockLevel: 0,
    }],
  },
  sm_body_02: {
    id: "sm_body_02",
    typeId: "sm_body_02",
    name: "High Summoner's Robe",
    description: "上級召喚士のローブ。召喚獣反撃型。",
    itemType: "equipment",
    type: "armor",
    equipmentSlot: "armor",
    durability: 250,
    ...
    skills: [
      {
        ...
        name: "Summon Counter",
        nameJa: "召喚反撃",
        description: "Summons counter attack when hit",
        descriptionJa: "被ダメージ時、ランダムな召喚獣が反撃(威力40)。召喚獣3体で確定反撃×3",
        effect: { type: "counterAttack", value: 40 },
        unlockLevel: 0,
      },
      {
        id: "summon_shield",
        name: "Summon Shield",
        nameJa: "召喚シールド",
        description: "Shield and debuff resistance from summons",
        descriptionJa: "ターン開始時、召喚獣数×25のシールド。召喚獣3体でデバフ耐性+80%",
        effect: { type: "shieldOnTurnStart", value: 25 },
        unlockLevel: 3,
      },
    ],
  },
  sm_body_03: {
    id: "sm_body_03",
    typeId: "sm_body_03",
    name: "Summon God's Robe",
    description: "召喚神のローブ。召喚獣の範囲化と回復。",
    itemType: "equipment",
    type: "armor",
    equipmentSlot: "armor",
    durability: 420,
    ...
    skills: [
      {
        id: "summon_supremacy",
        name: "Summon Supremacy",
        nameJa: "召喚無双",
        description: "AoE summon attacks and damage boost",
        descriptionJa: "召喚獣の攻撃が全て範囲化。召喚獣3体で全召喚獣の威力+100%",
        effect: { type: "bonusPerSummon", value: 100 },
        unlockLevel: 0,
      },
      {
        id: "summon_recovery",
        name: "Summon Recovery",
        nameJa: "召喚回復",
        description: "HP recovery from summon attacks",
        descriptionJa: "召喚獣攻撃時、召喚士HP回復+15。召喚獣3体で毎ターンHP+50回復",
        effect: { type: "healingBonus", value: 15 },
        unlockLevel: 3,
      },
    ],
  ...
  sm_weapon_01: {
    ...
    skills: [{
      ...
      name: "Summon Staff",
      nameJa: "召喚の杖",
      description: "Attack power scales with summon count",
      descriptionJa: "召喚獣1体につき召喚士の攻撃力+15%。召喚獣3体で+45%",
      effect: { type: "bonusPerSummon", value: 15 },
      unlockLevel: 0,
    }],
  },
  sm_weapon_02: {
    id: "sm_weapon_02",
    typeId: "sm_weapon_02",
    name: "High Summoner's Staff",
    description: "上級召喚士の杖。召喚獣強化と連携。",
    itemType: "equipment",
    type: "weapon",
    equipmentSlot: "weapon",
    durability: 130,
    ...
    skills: [
      {
        ...
        name: "Summon Amplify",
        nameJa: "召喚増幅",
        description: "Enhance summon stats",
        descriptionJa: "召喚獣のHP+50%、攻撃力+50%、行動速度+1(2回行動化)",
        effect: { type: "bonusPerSummon", value: 50 },
        unlockLevel: 0,
      },
      {
        id: "summon_chain",
        name: "Summon Chain",
        nameJa: "召喚連携",
        description: "Summons follow up on summoner attacks",
        descriptionJa: "召喚士が攻撃時、全召喚獣も追撃(威力20)。召喚獣3体で追撃×3",
        effect: { type: "damageBonus", value: 20 },
        unlockLevel: 3,
      },
    ],
  },
  sm_weapon_03: {
    id: "sm_weapon_03",
    typeId: "sm_weapon_03",
    name: "Summon God's Pact Staff",
    description: "召喚神の契約杖。召喚システム極限強化。",
    itemType: "equipment",
    type: "weapon",
    equipmentSlot: "weapon",
    durability: 270,
    ...
    skills: [
      {
        ...
        name: "Summon Release",
        nameJa: "召喚解放",
        description: "Major summon cost reduction and extra slots",
        descriptionJa: "召喚カードのコスト-2。維持コスト0。召喚上限+2(最大5体)",
        effect: { type: "classAbilityBonus", value: 2, classAbilityTarget: "summon" },
        unlockLevel: 0,
      },
      {
        id: "summon_ultimate",
        name: "Summon Ultimate",
        nameJa: "召喚の極致",
        description: "Ultimate summon enhancement",
        descriptionJa: "全召喚獣HP+100%、攻撃力+100%、3回行動。戦闘開始時自動召喚。死亡時50%復活",
        effect: { type: "bonusPerSummon", value: 100 },
        unlockLevel: 3,
      },
    ],
...
// --- Summoner Left Hand Equipment (2) ---
export const SUMMONER_OFFHAND: Record<string, EnhancedEquipmentData> = {
  sm_offhand_01: {
    id: "sm_offhand_01",
    typeId: "sm_offhand_01",
    name: "Summoner's Grimoire",
    description: "召喚士の魔導書。召喚数で手札増加。",
    itemType: "equipment",
    type: "offhand",
    equipmentSlot: "accessory1",
    durability: 85,
    ...
    skills: [{
      ...
      name: "Summon Book",
      nameJa: "召喚の書",
      description: "Draw cards based on summon count",
      descriptionJa: "手札+召喚獣数。召喚獣3体で手札+3",
      effect: { type: "drawBonus", value: 1, condition: "hasSummon" },
      unlockLevel: 0,
    }],
  },
  sm_offhand_02: {
    id: "sm_offhand_02",
    typeId: "sm_offhand_02",
    name: "High Summoner's Pact",
    description: "上級召喚士の契約書。犠牲特化ビルド。",
    itemType: "equipment",
    type: "offhand",
    equipmentSlot: "accessory1",
    durability: 140,
    ...
    skills: [
      {
        ...
        name: "Sacrifice Book",
        nameJa: "犠牲の書",
        description: "Enhanced sacrifice effects",
        descriptionJa: "犠牲カードのコスト-1。犠牲効果×1.5倍。犠牲後、同召喚獣を半額で再召喚可能",
      ...
      },
      {
        ...
        name: "Summon Record",
        nameJa: "召喚記録",
        description: "Recovery on summon death",
        descriptionJa: "召喚獣死亡時、そのHPの50%を召喚士が回復。5体以上召喚時、全召喚獣能力+50%",
...
// --- Summoner Boots Equipment (2) ---
export const SUMMONER_BOOTS: Record<string, EnhancedEquipmentData> = {
  sm_boots_01: {
    id: "sm_boots_01",
    typeId: "sm_boots_01",
    name: "Summoner's Boots",
    description: "召喚士のブーツ。召喚数でエナジー増加。",
    itemType: "equipment",
    type: "boots",
    equipmentSlot: "boots",
    durability: 65,
    ...
    skills: [{
      ...
      name: "Summon Speed",
      nameJa: "召喚加速",
      description: "Bonus energy based on summon count",
      descriptionJa: "召喚獣1体につきエナジー+1(最大+3)。召喚獣3体で初期エナジー+2追加",
      effect: { type: "energyBonus", value: 1, condition: "hasSummon" },
      unlockLevel: 0,
    }],
  },
  sm_boots_02: {
    id: "sm_boots_02",
    typeId: "sm_boots_02",
    name: "High Summoner's Swift Boots",
    description: "上級召喚士の疾風靴。連続召喚チャンス。",
    itemType: "equipment",
    type: "boots",
    equipmentSlot: "boots",
    durability: 100,
    ...
    skills: [
      {
        ...
        name: "Summon Cast",
        nameJa: "召喚詠唱",
        description: "Chance for extra summon",
        descriptionJa: "召喚カード使用時、15%で即座にもう1枚召喚。召喚獣3体で確率40%",
        effect: { type: "drawBonus", value: 1 },
        unlockLevel: 0,
      },
      {
        ...
        name: "Summon Evasion",
        nameJa: "召喚回避",
        description: "Evasion bonus from summons",
        descriptionJa: "召喚獣1体につき回避率+10%。召喚獣3体で回避率+30%",
        effect: { type: "statusResist", value: 10, condition: "hasSummon" },
        unlockLevel: 3,
      },
    ],
  },
...
// --- Summoner Accessory Equipment (2) ---
export const SUMMONER_ACCESSORIES: Record<string, EnhancedEquipmentData> = {
  sm_acc_01: {
    id: "sm_acc_01",
    typeId: "sm_acc_01",
    name: "Summon Ring",
    description: "召喚の指輪。召喚数増加と初期召喚。",
    itemType: "equipment",
    type: "accessory",
    equipmentSlot: "accessory2",
    durability: 45,
    ...
    skills: [{
      ...
      name: "Summon Enhance",
      nameJa: "召喚強化",
      description: "Extra summon slot and auto-summon",
      descriptionJa: "召喚上限+1(最大3体)。戦闘開始時、ランダムな召喚獣1体を自動召喚。召喚獣のHP+30%",
      effect: { type: "classAbilityBonus", value: 1, classAbilityTarget: "summon" },
      unlockLevel: 0,
    }],
  },
  sm_acc_02: {
    id: "sm_acc_02",
    typeId: "sm_acc_02",
    name: "Summon God's Bracelet",
    description: "召喚神の腕輪。召喚3体維持で自動攻撃。",
    itemType: "equipment",
    type: "accessory",
    equipmentSlot: "accessory2",
    durability: 75,
    ...
    skills: [
      {
        ...
        name: "Summon Burst",
        nameJa: "召喚爆発",
        description: "Auto AoE attack with 3 summons",
        descriptionJa: "召喚獣3体時、毎ターン自動全体攻撃(威力100)。召喚獣維持",
        effect: { type: "damageBonus", value: 100, condition: "hasSummon" },
        unlockLevel: 0,
      },
      {
        id: "summon_cycle",
        name: "Summon Cycle",
        nameJa: "召喚循環",
        description: "Cost reduction on summon death",
        descriptionJa: "召喚獣死亡時、次の召喚カードコスト-2。全召喚獣死亡時、3体まで無料で再召喚(1回/戦闘)",
        effect: { type: "classAbilityBonus", value: 2, classAbilityTarget: "summon" },
        unlockLevel: 3,
      },
    ],
